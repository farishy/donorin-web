  ...
  <div class="content-wrapper bg-light">
    ...
    <section class="content-header ml-4 mr-4">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Golongan Darah Table</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/dashboard/">Home</a></li>
              <li class="breadcrumb-item active">Golongan Darah Table</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered" width="100%">
                  ...
                  <tbody>
                    <?php foreach($golongandarah as $gd) :?>
                      <tr>
                      <th scope="row"><?= $gd['idGoldar'];?></th>
                      <td><?= $gd['golonganDarah'];?></td>
                      <td><?= $gd['rhesusGoldar'];?></td>
                      </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>
