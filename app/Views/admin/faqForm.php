<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper bg-light">
    ...
    <!-- Main content -->
    <form action="/dashboard/createfaq" enctype="multipart/form-data" method="post">
      <?= csrf_field(); ?>
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="custom-file">
                 <input id="icon" name="icon" type="file" class="custom-file-input" accept="image/png, image/jpg, image/jpeg" required="required"/>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="judulFaq" name="judulFaq" placeholder="Masukkan Judul FAQ" required="required">
                </div>
                <div class="form-group">
                    <label for="sinopsisFaq">Sinopsis FAQ</label>
                    <input type="text" class="form-control" id="sinopsisFaq" name="sinopsisFaq" placeholder="Masukkan Sinopsis FAQ" required="required">
                </div>
                <div class="form-group">
                    <label for="kontenFaq">Konten FAQ</label>
                    <textarea class="form-control" id="kontenFaq" name="kontenFaq" rows="20"></textarea>
                </div>
