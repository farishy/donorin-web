<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper bg-light">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Penulis Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
    <form action="/dashboard/createpenulis" enctype="multipart/form-data" method="post">
      <?= csrf_field(); ?>
            ...
            <div class="row">
              <div class="col-md">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="namaPenulis" name="namaPenulis" placeholder="Masukkan nama penulis" required="required">
                </div>
                <div class="form-group">
                    <label for="deskripsiPenulis">Deskripsi Penulis</label>
                    <input type="text" class="form-control" id="deskripsiPenulis" name="deskripsiPenulis" placeholder="Masukkan deskripsi penulis" required="required">
                </div>
                <div class="form-group">
                    <label for="gambarPenulis">Gambar Penulis</label>
                    <div class="input-group mb-3">
                <div class="custom-file">
                 <input id="gambarPenulis" name="gambarPenulis" type="file" class="custom-file-input" accept="image/png, image/jpg, image/jpeg" required="required"/>
